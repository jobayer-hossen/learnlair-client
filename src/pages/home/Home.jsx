...
console.log(data)
    const searchField = (event) => {
        ...
        fetch(`http://localhost:8000/searchName/${collageName}`)
            .then((res) => res.json())
            .then((data) => {
                getData(data);
            });
    ...
    return (
        ...
        <div className="relative">
            ...
            <input name='collageName' type="search"  className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write Collage Name"/>
