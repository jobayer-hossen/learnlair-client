        ...
        <div className="p-6">
          <header className="mb-4 flex gap-4">
            <div>
              ...
              <p className="text-sm text-slate-400">August 19 2020</p>
            </div>
          </header>
          <p>
          Business School of Entrepreneurship students delve into Stellar Evolution, examining the life cycles of stars and the cosmic processes that shape our universe.
          </p>
        </div>
        {/*  <!-- Action base sized link button --> */}
        <div className="text-center gap-2 p-2 pt-0">
          <a href="https://www.phys.soton.ac.uk/sites/www.phys.soton.ac.uk/files/PHYS3010-answers1415.pdf" target="_blank">
          <button className="inline-flex mt-7 h-10 items-center justify-center gap-2 justify-self-center bg-blue-200 whitespace-nowrap rounded px-5 text-sm font-medium tracking-wide text-blue-500 transition duration-300 hover:bg-blue-100 hover:text-blue-600 focus:bg-blue-200 focus:text-blue-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:text-blue-300 disabled:shadow-none disabled:hover:bg-transparent">
            <span>See Research Paper</span>
          </button>
          </a>
        </div>
        ...
        <div className="p-6">
          <header className="mb-4 flex gap-4">
            <div>
              ...
              <p className="text-sm text-slate-400">March 29 2016</p>
            </div>
          </header>
          <p>
          Medical University of Health Sciences students delve into Particle Physics, exploring the fundamental particles that govern the building blocks of the universe and medical applications.
          </p>
        </div>
        {/*  <!-- Action base sized link button --> */}
        <div className="text-center gap-2 p-2 pt-0">
          <a href="https://www.phys.soton.ac.uk/sites/www.phys.soton.ac.uk/files/PHYS6011-answers1415.pdf" target="_blank">
          <button className="inline-flex h-10 items-center justify-center gap-2 justify-self-center bg-blue-200 whitespace-nowrap rounded px-5 text-sm font-medium tracking-wide text-blue-500 transition duration-300 hover:bg-blue-100 hover:text-blue-600 focus:bg-blue-200 focus:text-blue-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:text-blue-300 disabled:shadow-none disabled:hover:bg-transparent">
            <span>See Research Paper</span>
          </button>
          </a>
        ...
        <div className="p-6">
          <header className="mb-4 flex gap-4">
            <div>
              ...
              <p className="text-sm text-slate-400">December 1 2022</p>
            </div>
          </header>
          <p>
          Culinary Institute of Gastronomy students excel in the Phys Final Year Synoptic Examination, merging science and culinary expertise to elevate gastronomic ingenuity.
          </p>
        </div>
        {/*  <!-- Action base sized link button --> */}
        <div className="text-center gap-2 p-2 pt-0">
