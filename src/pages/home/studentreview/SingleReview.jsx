...
const SingleReview = ({reviews}) => {
    // console.log(reviews)
    const {review,rating,image,candidateName,collegeName} = reviews;
    return (
    <>
      {/*      <!-- Component: Elevated centered base sized testimonial with avatar and rating stars --> */}
      <div className="w-[70%] mx-auto overflow-hidden text-center bg-blue-50 rounded shadow-2xl text-slate-500 shadow-blue-200 mt-5 mb-5">
        ...
        <div className="relative p-6">
          ...
          <p className='text-gray-600 '>
            ...
            <blockquote className="p-6 leading-relaxed">
    ...
    />
              ...
              <div className="flex items-center gap-4 pt-4 text-sm text-left text-indigo-500">
                <img
                  src={image}
                  alt="user name"
                  title="user name"
                ...
                <div className="flex flex-col gap-1">
                  <span className=" text-xl uppercase">{candidateName}</span>
                </div>
              </div>
            </figcaption>
          </figure>
          <svg
            aria-hidden="true"
            className="absolute z-0 h-20 left-0 top-0"
            viewBox="0 0 17 12"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            aria-hidden="true"
            className="absolute z-0 h-16 right-0 bottom-0"
            viewBox="0 0 17 12"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      {/*      <!-- End Elevated centered base sized testimonial with avatar and rating stars --> */}            
    </>
    );
};
